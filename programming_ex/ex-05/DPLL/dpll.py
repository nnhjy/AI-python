...
def unit_propagation(valuation, clauses):
    ...
    * Otherwise, if all literals of a clause are False, then the whole clause
    ...
    #         # 1.3
    #         if (len(false_literal) == len(clause) - 1) and (len(unassigned_literal) == 1):
    #             valuation[unassigned_literal[0]] = unassigned_value
    #             unit_clause.append(clause)

    #         # 1.4
    #         if len(false_literal) == len(clause):
    #             return (False, {})
